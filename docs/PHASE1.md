...
4. eve CANVAS agent + `ce_jobs` / `ce_items` (Content Engine creation seat)
5. Next.js 16.3 App Router skeleton with auth, onboarding chat, dashboard, pricing
6. Docs: architecture, schema, eve-tools, signal-report-tools, canvas
...
- [x] CANVAS eve agent writes `ce_jobs` / `ce_items` (parallel press_card + linkedin; visual_spec optional)
